...
export default function data(props, inputData_cv) {
    //console.log(props)
    //console.log(inputData_cv)
    const { data: growths, isPending, error } = useFetch('https://localhost:5001/api/growth/farm/cow/cv/05/2019/10', props.refreshData);
